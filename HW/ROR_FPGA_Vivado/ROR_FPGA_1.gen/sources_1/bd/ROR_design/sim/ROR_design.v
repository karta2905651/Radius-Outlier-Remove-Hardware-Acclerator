...
//Command     : generate_target ROR_design.bd
//Design      : ROR_design
//Purpose     : IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "ROR_design,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=ROR_design,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=7,numReposBlks=7,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=1,numPkgbdBlks=0,bdsource=USER,da_axi4_cnt=2,da_clkrst_cnt=10,da_ps7_cnt=1,synth_mode=Hierarchical}" *) (* HW_HANDOFF = "ROR_design.hwdef" *) 
module ROR_design
   (DDR_addr,
    DDR_ba,
    DDR_cas_n,
  ...
  wire [127:0]ROR_IP_0_m00_axis_TDATA;
  wire ROR_IP_0_m00_axis_TLAST;
  wire ROR_IP_0_m00_axis_TREADY;
  wire ROR_IP_0_m00_axis_TVALID;
  ...
  ROR_design_ROR_IP_0_4 ROR_IP_0
       (.m00_axis_aclk(processing_system7_0_FCLK_CLK0),
        .m00_axis_aresetn(rst_ps7_0_100M_peripheral_aresetn),
        .m00_axis_tdata(ROR_IP_0_m00_axis_TDATA),
        .m00_axis_tlast(ROR_IP_0_m00_axis_TLAST),
        .m00_axis_tready(ROR_IP_0_m00_axis_TREADY),
        .m00_axis_tvalid(ROR_IP_0_m00_axis_TVALID),
  ...
  ROR_design_axi_dma_0_0 axi_dma_0
       (.axi_resetn(rst_ps7_0_100M_peripheral_aresetn),
        ...
        .s_axis_s2mm_tdata(ROR_IP_0_m00_axis_TDATA),
        .s_axis_s2mm_tkeep({1'b1,1'b1,1'b1,1'b1,1'b1,1'b1,1'b1,1'b1,1'b1,1'b1,1'b1,1'b1,1'b1,1'b1,1'b1,1'b1}),
        .s_axis_s2mm_tlast(ROR_IP_0_m00_axis_TLAST),
        .s_axis_s2mm_tready(ROR_IP_0_m00_axis_TREADY),
        .s_axis_s2mm_tvalid(ROR_IP_0_m00_axis_TVALID));
  ROR_design_axi_smc_0 axi_smc
  ...
  ROR_design_processing_system7_0_0 processing_system7_0
       (.DDR_Addr(DDR_addr),
        .DDR_BankAddr(DDR_ba),
        .DDR_CAS_n(DDR_cas_n),
        .DDR_CKE(DDR_cke),
  ...
  ROR_design_rst_ps7_0_100M_0 rst_ps7_0_100M
       (.aux_reset_in(1'b1),
        .dcm_locked(1'b1),
  ...
  ROR_design_smartconnect_0_0 smartconnect_0
       (.M00_AXI_araddr(smartconnect_0_M00_AXI_ARADDR),
        ...
        .aclk(processing_system7_0_FCLK_CLK0),
        .aresetn(rst_ps7_0_100M_peripheral_aresetn));
  ROR_design_xlconcat_0_0 xlconcat_0
