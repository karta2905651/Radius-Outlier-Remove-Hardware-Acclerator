...
// Command     : write_verilog -force -mode synth_stub -rename_top ROR_design_axi_smc_0 -prefix
//               ROR_design_axi_smc_0_ ROR_design_axi_smc_0_stub.v
...
(* CHECK_LICENSE_TYPE = "ROR_design_axi_smc_0,bd_c225,{}" *) (* CORE_GENERATION_INFO = "ROR_design_axi_smc_0,bd_c225,{x_ipProduct=Vivado 2025.1,x_ipVendor=xilinx.com,x_ipLibrary=ip,x_ipName=smartconnect,x_ipVersion=1.0,x_ipCoreRevision=27,x_ipLanguage=VERILOG,x_ipSimLanguage=MIXED}" *) (* DowngradeIPIdentifiedWarnings = "yes" *) 
(* X_CORE_INFO = "bd_c225,Vivado 2025.1" *) 
module ROR_design_axi_smc_0(aclk, aresetn, S00_AXI_awid, S00_AXI_awaddr, 
