...
HD_PWD='C:/Users/karta/ROR_FPGA_1/ROR_FPGA_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ROR_design_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ROR_design_wrapper.tcl
