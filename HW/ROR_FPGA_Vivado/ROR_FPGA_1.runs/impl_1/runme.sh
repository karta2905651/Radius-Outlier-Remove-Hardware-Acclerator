...
HD_PWD='C:/Users/karta/ROR_FPGA_1/ROR_FPGA_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ROR_design_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ROR_design_wrapper.tcl -notrace
