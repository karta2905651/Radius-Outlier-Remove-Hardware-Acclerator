...
HD_PWD='C:/Users/karta/ROR_FPGA_1/ROR_FPGA_1.runs/ROR_design_processing_system7_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ROR_design_processing_system7_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ROR_design_processing_system7_0_0.tcl
