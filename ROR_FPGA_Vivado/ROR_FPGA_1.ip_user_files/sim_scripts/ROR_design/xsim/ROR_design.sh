...
#
# Script generated by Vivado on Tue Feb 24 21:37:34 +0800 2026
# SW Build 6140274 on Thu May 22 00:12:29 MDT 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : ROR_design.sh
...
#
# Usage        : ROR_design.sh
#                ROR_design.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                ROR_design.sh [-reset_run]
#                ROR_design.sh [-reset_log]
#                ROR_design.sh [-help]
#
...
# script info
echo -e "ROR_design.sh - Script generated by export_simulation (Vivado v2025.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./ROR_design.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L axi_infrastructure_v1_1_0 -L axi_vip_v1_1_21 -L processing_system7_vip_v1_0_23 -L axi_datamover_v5_1_37 -L axi_sg_v4_1_21 -L axi_dma_v7_1_36 -L xlconstant_v1_1_10 -L proc_sys_reset_v5_0_17 -L smartconnect_v1_0 -L axi_register_slice_v2_1_35 -L xlconcat_v2_1_7 -L uvm -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot ROR_design xil_defaultlib.ROR_design xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim ROR_design -key {Behavioral:sim_1:Functional:ROR_design} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_c225.protoinst" -protoinst "protoinst_files/bd_3b23.protoinst" -protoinst "protoinst_files/ROR_design.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb ROR_design.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./ROR_design.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: ROR_design.sh [-help]\n\
Usage: ROR_design.sh [-step]\n\
Usage: ROR_design.sh [-lib_map_path]\n\
Usage: ROR_design.sh [-reset_run]\n\
Usage: ROR_design.sh [-reset_log]\n\
Usage: ROR_design.sh [-keep_index]\n\
Usage: ROR_design.sh [-noclean_files]\n\n\
