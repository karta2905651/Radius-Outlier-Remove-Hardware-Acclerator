...
#
# Script generated by Vivado on Tue Nov 18 21:47:41 +0800 2025
# SW Build 6140274 on Thu May 22 00:12:29 MDT 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : ROR_IP_0.sh
...
#
# Usage        : ROR_IP_0.sh
#                ROR_IP_0.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                ROR_IP_0.sh [-reset_run]
#                ROR_IP_0.sh [-reset_log]
#                ROR_IP_0.sh [-help]
#
...
# script info
echo -e "ROR_IP_0.sh - Script generated by export_simulation (Vivado v2025.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./ROR_IP_0.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot ROR_IP_0 xil_defaultlib.ROR_IP_0 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim ROR_IP_0 -key {Behavioral:sim_1:Functional:ROR_IP_0} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_c225.protoinst" -protoinst "protoinst_files/bd_3b23.protoinst" -protoinst "protoinst_files/bd_8c19.protoinst" -protoinst "protoinst_files/ROR_design.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb ROR_IP_0.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./ROR_IP_0.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: ROR_IP_0.sh [-help]\n\
Usage: ROR_IP_0.sh [-step]\n\
Usage: ROR_IP_0.sh [-lib_map_path]\n\
Usage: ROR_IP_0.sh [-reset_run]\n\
Usage: ROR_IP_0.sh [-reset_log]\n\
Usage: ROR_IP_0.sh [-keep_index]\n\
Usage: ROR_IP_0.sh [-noclean_files]\n\n\
